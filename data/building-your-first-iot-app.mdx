...
- Then select **NodeMCU 1.0 (ESP 12-E Module)**.
...
To control the on-board LED on the ESP8266, go the Grandeur Dashboard and run the Canvas app you made in the previous tutorial. A Canvas guide is also lsited below. 
