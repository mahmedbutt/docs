...
With grandeur-mdx, all your `.md` and `.mdx` files under the pages directory will be rendered with [MDX](https://mdxjs.com/about), it's an
...
```markdown
> <Callout emoji="💡">
>   Give [**grandeur-mdx**](https://github.com/shuding/grandeur-mdx) a star!
> </Callout>
```
## Callout
Callout can have different types
...
## Tabs
You can use tabs to organize information with label

<Tabs>

  <Item value="0" label="First">**Hello**</Item>

  <Item value="1" label="Second">**World**</Item>

</Tabs>

Tabs can include any based data, like code
<Tabs>
