...
In each project you can register users either through the app SDKs or through the dashboard. You can also create a user to delegate the access. This means, you can provide these credentials to end users or end users can directly register themselves through your app to access features of Grandeur. This way you can build an auth layer in your apps.
...
[Signing Up](/images/guides/signing-up.webm)

Here's how a user account can be created from the dashboard itself. 
...
To control the device from the app, you'll need a user account on the dashboard. After your user account is made, make sure you pair it with your device.
 ...
 [Creating a User Account](/images/guides/user-add.webm)
...
[Deleting a User Account](/images/guides/delete-account.webm)
